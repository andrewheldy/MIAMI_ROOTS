...
[`community-first-redesign.md`](community-first-redesign.md). **This is not a milestone.**
It touches no database, migration, RLS policy, or hosted project, and it does not advance
